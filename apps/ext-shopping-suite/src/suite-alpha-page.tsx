              ...
              <div className="space-y-3">
                ...
                <div className="shopflow-soft-panel rounded-[1.5rem] px-4 py-4">
                  <div>
                    ...
                    <p className="mt-2 text-sm font-semibold text-stone-900">
                      {localizedAppDefinition.startHere[2]?.title ??
                        copy.alphaGuardrailsHeading}
                    </p>
                    <p className="mt-1 text-xs text-stone-600">
                      {localizedAppDefinition.startHere[2]?.summary ??
                        localizedAppDefinition.operatorPromise}
                    </p>
                  </div>
                  <div className="mt-4 flex flex-wrap gap-2">
                    {localizedAppDefinition.startHere.map((item) => (
                      <a
                        key={item.title}
                        className="inline-flex rounded-full border border-stone-200 bg-white px-3 py-2 text-xs font-medium text-stone-700"
                        href={item.href}
                      >
                        {item.ctaLabel}
                      </a>
