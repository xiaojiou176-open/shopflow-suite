...
| :------------ | :--------------------------------------------------------------- | :-------------------------------------------------------------------- | :----------------------------------------------------- | :---------------------------------------------------------------------------------------------------------- |
| `Codex`       | `pnpm cli:read-only -- agent-target-packet --target codex`       | `pnpm cli:read-only -- plugin-marketplace-metadata --target codex`    | [Codex Quickstart](./codex-quickstart.md)              | official Codex integration, or claiming Shopflow is already listed or published on the official Codex plugin/directory surface |
