...
| paste-ready repo description or release copy                                             | [Ready-to-Sync Public Copy Packet](./public-copy.ready.md)                                                      | this is the builder-facing copy packet, not proof that anything has already been externally published                                                                                                    |
| one repo-owned packet for current package / plugin / skills / marketplace execution, plus future API / MCP transport | `pnpm cli:read-only -- public-distribution-bundle` and [Public Distribution Bundle](./public-distribution-bundle.ready.md) | this keeps current distribution work concrete without pretending that every target already has an official listing surface                                                                               |
